...
test("simple one address function", function (t) {
    ...
    result = fxn("\"FranÃ§oise LefÃ¨vre\"@example.com");
    t.ok(result, "RFC 6532 (Unicode support) is enabled by default");
    t.equal(result.parts.local.semantic, "FranÃ§oise LefÃ¨vre");
...
test("rfc5322 parser", function (t) {
    ...
    result = fxn({ input: "\"FranÃ§oise LefÃ¨vre\"@example.com", rfc6532: true });
...
test("unicode support", function (t) {
    ...
    result = fxn("æ¨å­å®‡ <xiaoyu@example.com>");
